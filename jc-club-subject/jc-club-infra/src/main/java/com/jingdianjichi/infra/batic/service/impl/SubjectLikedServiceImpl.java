...
import com.jingdianjichi.infra.batic.mapper.SubjectLikedDao;
...
public class SubjectLikedServiceImpl implements SubjectLikedService {
    ...
    @Override
    public List<SubjectLiked> pageLiked(SubjectLiked subjectLiked, Integer start, Integer pageSize) {
        return   this.subjectLikedDao.queryPage(subjectLiked,start,pageSize);
    }
