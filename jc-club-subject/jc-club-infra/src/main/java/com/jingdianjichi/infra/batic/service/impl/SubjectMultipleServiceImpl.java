...
import com.jingdianjichi.infra.batic.mapper.SubjectMultipleDao;
...
public class SubjectMultipleServiceImpl implements SubjectMultipleService {
    ...
    @Override
    public void batchInsert(List<SubjectMultiple> multipleList) {
        this.subjectMultipleDao.insertBatch(multipleList);
    }
